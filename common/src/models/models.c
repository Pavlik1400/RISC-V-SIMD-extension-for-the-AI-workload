...
// My_models_anchor
#if defined(INCLUDE_MODEL_CNN_1D_V012_SMALL_RADIO_ML18) || defined(INCLUDE_ALL_TFLM_EXAMPLES)
        MENU_ITEM(AUTO_INC_CHAR, "cnn_1d_v012_small_radio_ml18", cnn_1d_v012_small_radio_ml18_menu),
#endif
...
#endif  
#if defined(INCLUDE_MODEL_SIMC_3_MIXED_V2_NO_QUANT) || defined(INCLUDE_ALL_TFLM_EXAMPLES)
        MENU_ITEM(AUTO_INC_CHAR, "Signal modulation classification model 3 no quant", simc_3_MIXED_v2_no_quant_menu),
#endif  
